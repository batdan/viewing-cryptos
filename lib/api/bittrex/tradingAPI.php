...
/**
 * Trading sur l'Exchange Bittrex
 *
 * API documentation :
...
class tradingAPI
{
	...
	private $_apiKey       = '5049b1f9ba2549f5b27bd622b5cbc17d';
	private $_apiSecret    = '89a494f6d9c240479398a2fc4dbfee2f';
    private $_apiSign;
	 ...
	 * Constructeur
	 */
	public function __construct($apiKey=null, $apiSecret=null, $bddName=null)
	{
		// Instance PDO
        $this->_dbh = \core\dbSingleton::getInstance($bddName);
