...
/**
 * Récupération et stockage de l'intégralité des markets Bitfinex
 *
 * @author Daniel Gomes
 */
class summariesToBddRest
{
    ...
    private $_getMarket;                                // Instance de la classe cryptos\bitfinex\getMarket
    ...
    private $_rotateTime    = 25;                       // Temps de conservation des données en heures
	...
	public function __construct()
	{
        ...
        // Instance de la classe cryptos\bitfinex\getMarket
        $this->_getMarket = new \cryptos\api\bitfinex\getMarket();
    ...
    private function majBdd()
    {
        ...
        foreach ($this->_marketSummaries as $val) {
            ...
            $marketName     = substr($val[0], 4, 3) . '-' . substr($val[0], 1, 3);
