...
class marketHistoryToBdd
{
    ...
    public function saveMarketHistory($marketName, $networkInterface)
    {
        ...
        $getMarketHistory = \cryptos\api\poloniex\getMarket::getMarketHistory($marketName, 60, $curlOptInterface);
