...
class tradingMultiDevises
{
    ...
    private $_addBidPct         = 0.001;    // Pourcentage ajouté au Bid le plus haut
    private $_addAskPct         = 0.001;    // Pourcentage retiré au Ask le plus bas
    ...
    private $_seuilMini         = -1000.0;      // Seuil de gains à atteindre avant d'acheter une devise
    private $_btcMinVolume      = 200;      // Volume minimum avant de se lancer dans un market
